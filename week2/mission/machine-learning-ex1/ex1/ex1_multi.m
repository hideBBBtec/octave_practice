...
% fprintf('Theta computed from gradient descent _1: \n');
% fprintf(' %f \n', theta);
% fprintf('\n');
...
% % Display gradient descent's result
% fprintf('Theta computed from gradient descent _2: \n');
% fprintf(' %f \n', theta);
% fprintf('\n');
...
% % Display gradient descent's result
% fprintf('Theta computed from gradient descent _3: \n');
% fprintf(' %f \n', theta);
% fprintf('\n');
...
figure;
plot(1:numel(J5), J5, '-b', 'LineWidth', 2);
xlabel('Number of iterations');
ylabel('Cost J');
% hold on;
% plot(1:numel(J2), J2, '-r', 'LineWidth', 2)
% plot(1:numel(J3), J3, '-k', 'LineWidth', 2)
% plot(1:numel(J4), J4, '-b', 'LineWidth', 2)
% plot(1:numel(J5), J5, '-r', 'LineWidth', 2)
% plot(1:numel(J6), J6, '-k', 'LineWidth', 2)
% plot(1:numel(J7), J7, '-b', 'LineWidth', 2)
